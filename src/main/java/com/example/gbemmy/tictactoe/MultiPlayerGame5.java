...
/**
 * Created by Gbemmy on 15/04/2018.
 */

public class MultiPlayerGame5 extends Activity {

    private Button mPlayBoard[][] = new Button[5][5];
    ...
    //***This display the initial layout of the game.

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.multi_player_game_activity_5);
        ...
        for (int a = 0; a < 5; a++) {
            for (int b = 0; b < 5; b++) {
                mPlayBoard[a][b] = (Button) grid.getChildAt(5 * a + b);
    ...
    public void clickMove(View view) {
        ...
        int b = index % 5;
        flag = 0;
        if (turn == 1 && gameOver == 0 && !(mPlayBoard[a][b].getText().toString().equals("X")) && !(mPlayBoard[a][b].getText().toString().equals("O"))) {
            ...
            turn = 2;
        } else if (turn == 2 && gameOver == 0 && !(mPlayBoard[a][b].getText().toString().equals("X")) && !(mPlayBoard[a][b].getText().toString().equals("O"))) {
            if (flipValue == 0) {
                displayTurn = player1Name + "'s turn (X)";
                playerTurn.setText(displayTurn);
            } else if (flipValue == 1) {
        ...
        if (gameOver == 0) {
            for (a = 0; a < 5; a++) {
                for (b = 0; b < 5; b++) {
                    if (!mPlayBoard[a][b].getText().toString().equals("X") && !mPlayBoard[a][b].getText().toString().equals("O")) {
                        flag = 1;
                        break;
    ...
    public void checkWin() {
        for (int a = 0; a < 5; a++) {
            if (mPlayBoard[a][0].getText().toString().equals(mPlayBoard[a][1].getText().toString()) && mPlayBoard[a][0].getText().toString().equals(mPlayBoard[a][2].getText().toString()) && mPlayBoard[a][0].getText().toString().equals(mPlayBoard[a][3].getText().toString()) && mPlayBoard[a][0].getText().toString().equals(mPlayBoard[a][4].getText().toString())) {
                ...
                if (!mPlayBoard[a][0].getText().toString().equals(" ")) {
                    ...
                    mPlayBoard[a][3].setTextColor(Color.BLUE);
                    mPlayBoard[a][4].setTextColor(Color.BLUE);

                }

            }
            if (mPlayBoard[0][a].getText().toString().equals(mPlayBoard[1][a].getText().toString()) && mPlayBoard[0][a].getText().toString().equals(mPlayBoard[2][a].getText().toString()) && mPlayBoard[0][a].getText().toString().equals(mPlayBoard[3][a].getText().toString()) && mPlayBoard[0][a].getText().toString().equals(mPlayBoard[4][a].getText().toString())) {
                ...
                if (!mPlayBoard[0][a].getText().toString().equals(" ")) {
                    ...
                    mPlayBoard[3][a].setTextColor(Color.BLUE);
                    mPlayBoard[4][a].setTextColor(Color.BLUE);
                }
        ...
        if (mPlayBoard[0][0].getText().toString().equals(mPlayBoard[1][1].getText().toString()) && mPlayBoard[0][0].getText().toString().equals(mPlayBoard[2][2].getText().toString()) && mPlayBoard[0][0].getText().toString().equals(mPlayBoard[3][3].getText().toString()) && mPlayBoard[0][0].getText().toString().equals(mPlayBoard[4][4].getText().toString())) {
            ...
            if (!mPlayBoard[0][0].getText().toString().equals(" ")) {
                ...
                mPlayBoard[3][3].setTextColor(Color.BLUE);
                mPlayBoard[4][4].setTextColor(Color.BLUE);
            }


        }
        if (mPlayBoard[0][4].getText().toString().equals(mPlayBoard[1][3].getText().toString()) && mPlayBoard[0][4].getText().toString().equals(mPlayBoard[2][2].getText().toString()) && mPlayBoard[0][4].getText().toString().equals(mPlayBoard[3][1].getText().toString()) && mPlayBoard[0][4].getText().toString().equals(mPlayBoard[4][0].getText().toString())) {
            if (mPlayBoard[0][4].getText().toString().equals("X")) {
                gameOver = 1;
                if (flipValue == 0)
                    win = 1;
                else if (flipValue == 1)
            ...
            } else if (mPlayBoard[0][4].getText().toString().equals("O")) {
                gameOver = 1;
                if (flipValue == 0)
                    win = 2;
                else if (flipValue == 1)
            ...
            if (!mPlayBoard[4][0].getText().toString().equals(" ")) {
                mPlayBoard[4][0].setTextColor(Color.BLUE);
                mPlayBoard[3][1].setTextColor(Color.BLUE);
                mPlayBoard[2][2].setTextColor(Color.BLUE);
                mPlayBoard[1][3].setTextColor(Color.BLUE);
                mPlayBoard[0][4].setTextColor(Color.BLUE);
            }
    ...
    public void onRClick(View v) {
        ...
        mRestart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MultiPlayerGame5.this, "Game Restarted!", Toast.LENGTH_SHORT).show();
                startActivity(start);
